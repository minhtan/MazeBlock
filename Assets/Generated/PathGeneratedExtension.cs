...
namespace Entitas {
    ...
    public partial class Entity {
        ...
        public Entity AddPath(System.Collections.Generic.Queue<Entitas.Entity> newNodes) {
            var component = CreateComponent<Path>(ComponentIds.Path);
            component.nodes = newNodes;
            return AddComponent(ComponentIds.Path, component);
        }

        public Entity ReplacePath(System.Collections.Generic.Queue<Entitas.Entity> newNodes) {
            var component = CreateComponent<Path>(ComponentIds.Path);
            component.nodes = newNodes;
